...
lecturer_1 = Lecturer('James', 'Clark')
lecturer_1.courses_attached += ['Python']
lecturer_1.courses_attached += ['Git']

lecturer_2 = Lecturer('Carmel', 'Summers')
...
student_1.rate_lect(lecturer_1, 'Git', 10)
...
student_2.rate_lect(lecturer_2, 'Git', 7)
student_2.rate_lect(lecturer_2, 'Git', 7)
